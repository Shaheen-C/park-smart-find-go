        ...
        <CardContent className="p-0 h-full">
          {showPlaceholder ? (
            ...
            >
              ...
              <div className="bg-gradient-to-br from-green-50 to-blue-50 h-full flex items-center justify-center border border-green-200">
                <div className="text-center p-4">
                  <MapPin className="h-16 w-16 mx-auto mb-4 text-green-600" />
                  <p className="text-lg font-semibold text-gray-800 mb-2">Map Location</p>
                  <p className="text-sm text-gray-600 mb-4">{location}</p>
                  <div className="inline-flex items-center px-3 py-2 bg-green-600 text-white rounded-lg text-sm hover:bg-green-700 transition-colors">
